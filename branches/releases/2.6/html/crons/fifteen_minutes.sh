...
php /var/www/lighthouse-uxd/lighthouse/html/crons/cron.activate_wo.php
if [ $? != 0 ]; then
...
php /var/www/lighthouse-uxd/lighthouse/html/crons/cron.companies.php
if [ $? != 0 ]; then
...
php /var/www/lighthouse-uxd/lighthouse/html/crons/cron.users.php
if [ $? != 0 ]; then
...
php /var/www/lighthouse-uxd/lighthouse/html/crons/cron.projects.php
if [ $? != 0 ]; then
...
php /var/www/lighthouse-uxd/lighthouse/html/crons/cron.perms.php
if [ $? != 0 ]; then
...
php /var/www/lighthouse-uxd/lighthouse/html/crons/cron_wo_alerts.php
if [ $? != 0 ]; then
/bin/mail -s "15 Min Cron Failed - cron_wo_alerts.php" ots-tools-support@nbcuni.com
else
echo "cron_wo_alerts.php exit status good" >> /var/www/lighthouse-uxd/lighthouse/html/crons/fifteen_minutes.log
fi

php /var/www/lighthouse-uxd/lighthouse/html/crons/cron.users.delete.php
if [ $? != 0 ]; then
/bin/mail -s "15 Min Cron Failed - cron.users.delete.php" ots-tools-support@nbcuni.com
else
echo "cron.users.delete.php exit status good" >> /var/www/lighthouse-uxd/lighthouse/html/crons/fifteen_minutes.log
fi
