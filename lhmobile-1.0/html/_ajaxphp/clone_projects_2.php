<?PHP
	...
	while($row = $project_list->fetch_assoc()) {
		...
		{  // echo $i++;
			...
			$mysql->sqlordie("UPDATE workorders SET `archived`='1' WHERE `project_id` = '".$clone_project_id."' and status ='1'");
			$mysql->sqlordie("UPDATE qa_defects SET `project_id`='".$newProjectID."' WHERE `project_id` = '".$clone_project_id."'");
			...
			$mysql->sqlordie($deleteoldProject2011);
