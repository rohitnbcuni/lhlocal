<?PHP
	...
	WHERE rb.datestamp >= '".$fromDate."' and rb.datestamp < '".$toDate."' and rb.daypart <> '5' and rb.status <> '2' and status <> '3' and pb.deleted = '0' and pb.active = '1' and pb.program='9' and  p.archived ='0' and p.active = '1' and p.deleted ='0' GROUP BY project_code,DAY(rb.datestamp),pb.first_name,pb.last_name
UNION 
SELECT 
	project_code,
	p.project_name as title,
