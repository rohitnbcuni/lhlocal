...
/* UPDATED April 5, 2012  B.Roden*/  


var s_account="nbcuglobal,nbcudpslighthouse"; 
...
s.linkInternalFilters="javascript:,lighthouse.nbcudps.com/,lighthouse.nbcuots.com/";
s.linkDownloadFileTypes="exe,zip,wav,mp3,mov,mpg,avi,wmv,doc,pdf,xls,aspx"
...
function s_doPlugins(s) {
	...
	if (s.campaign == '') {s.campaign=s.getQueryParam('cid,__source',':');}           
	...
	if(!s.prop35) {s.prop35=s.getQueryParam("nxa");}


			
	//eVars
	s.eVar6 = s.getQueryParam("query").replace("+", ' '); // placeholder for search function
	s.eVar7 = s.getQueryParam("internal"); // placeholder for search function
	...
	s.eVar21 = s.getQueryParam("nlcid");  
	...
	s.hier1 = s.channel + " | " + s.prop2 + " | " + s.prop10 +" | " + s.prop3 + " | " + s.prop4;
