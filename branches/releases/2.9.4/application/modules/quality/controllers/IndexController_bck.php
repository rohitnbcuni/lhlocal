		...
		public function createAction() {
			...
			if(isset($_GET['defect_id'])) {
				...
				if(!empty($qa_cookie_values))
				{
					...
					$version_cookie = strtok(@$qa_cookie_part[8], "V:");
				}
...
//			echo $qa_selected_sort_cookie;die();
      echo '<div class="column_full_workorders_QA">
				...
				<div class="title_med workorders_filter">
					...
					<h4>Defect Entry</h4>
				  <form id = "prevNextNav" method = "POST">  
					...
					<div class="workorder_content_col1">
						...
						if(!isset($_GET['defect_id'])) {										
							echo '<li>
								...
								echo QaDisplay::getProjectOptionEditHTML($pj_cookie);
								echo '</select>
							...
							echo '</li>
							<li>
								<label for="wo_desc" id="wo_desc_label">Description:</label>
								<textarea name="wo_desc" id="wo_desc" class="field_large">' .@$wo_data[0]['body'] .'</textarea>
							</li>
							...
							<div class="side_bucket_content">
								...
								if(isset($_GET['defect_id'])) {
									echo '<li>
										...
										echo QaDisplay::getProjectOptionEditHTML($wo_data[0]['project_id']);									
										echo '</select>
