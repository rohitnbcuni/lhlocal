<?php
	...
	$new_phase_result = $mysql->query($new_phase_sql);
	...
	$result = $mysql->query($project_list);
	...
	function save_phase_data($mysql, $prev_proj_id, $prev_proj_phase_hours, $prev_proj_phase_id, $new_phase_id, $update_sql, $flag){
		...
		$sub_phase_present_result = $mysql->query($sub_phase_present_sql)->fetch_assoc();
		...
		if($sub_phase_present_result['record_count'] > count($update_sql)){
			...
			$proj_phase_hours = $mysql->query($proj_phase_hours_sql)->fetch_assoc();
