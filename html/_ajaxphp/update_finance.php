<?PHP
	...
	if(@$_GET['action'] == "save") {
		$totalBudget = $mysql->real_escape_string(@$_GET['totalBudget']);
		$quarterOneBudget = $mysql->real_escape_string(@$_GET['quarter1']);
		$quarterTwoBudget = $mysql->real_escape_string(@$_GET['quarter2']);
		$quarterThreeBudget = $mysql->real_escape_string(@$_GET['quarter3']);
		$quarterFourBudget = $mysql->real_escape_string(@$_GET['quarter4']);
