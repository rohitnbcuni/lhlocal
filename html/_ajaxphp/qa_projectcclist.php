<?PHP
		...
		include("sessionHandler.php");
				...
				if(ISSET($_GET['remove'])){
					$removeUser = $mysql->real_escape_string($_GET['remove']);
                ...
                if(!empty($list[$x])) {
					if($removeUser != $list[$x]){
						...
						$listu .= "<li>"
								...
								."<button class=\"status cclist_remover\" onClick=\"removeCcUser(" .$list[$x] ."); return false;\"><span>remove</span></button>"
								."</li>";
