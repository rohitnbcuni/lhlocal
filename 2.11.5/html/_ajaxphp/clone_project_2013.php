<?PHP
	...
	while($row = $project_list->fetch_assoc()) {
		...
		$newProject = "INSERT INTO `projects` (`bc_id`,`project_code`,`bc_category_id`,`budget_code`,`project_name`,`company`,`desc`, `business_case`,`scope`,`deliverables`,`owner_approval`,`company_approval`,`metrics_tracking`,`archived`,`active`,`deleted`, `rp_permission`,`project_status`,`wo_permission`,`internal_groups`,`YEAR`,`clone_project_id`,`cclist`,`qccclist`,`program`) VALUES ('".$row['bc_id']."','".$mysql->real_escape_string($row['project_code'])."','".$row['bc_category_id']."','".$mysql->real_escape_string($row['budget_code'])."','".$mysql->real_escape_string($row['project_name'])."','".$mysql->real_escape_string($row['company'])."','".$mysql->real_escape_string($row['desc'])."','".$mysql->real_escape_string($row['business_case'])."','".$mysql->real_escape_string($row['scope'])."','".$mysql->real_escape_string($row['deliverables'])."','".$mysql->real_escape_string($row['owner_approval'])."','".$mysql->real_escape_string($row['company_approval'])."','".$mysql->real_escape_string($row['metrics_tracking'])."','".$row['archived']."','".$row['active']."','".$row['deleted']."','".$row['rp_permission']."','".$row['project_status']."','".$row['wo_permission']."','".$row['internal_groups']."','".$current_year."','".$clone_project_id."','".$row['cclist']."','".$row['qccclist']."','".$row['program']."')";
