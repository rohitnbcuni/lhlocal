...
function mobile_device_detect($iphone=true,$android=true,$opera=true,$blackberry=true,$mobileredirect=false,$desktopredirect=false){
if(!array_key_exists('HTTP_USER_AGENT',$_SERVER) || !array_key_exists('HTTP_ACCEPT',$_SERVER)){
  ...
  switch(true){ // using a switch against the following statements which could return true is more efficient than the previous method of using if statements
    ...
    case (eregi('ipod',$user_agent)||eregi('iphone',$user_agent) || eregi('ipad',$user_agent)); // we find the words iphone or ipod in the user agent
	  ...
	  {
		// if user agent is ipad then do not redirect to mobile
...
/* Commented out the redirect part as this would be handled in the bootstrap
