...
(function($) {
	...
	$.fn.jHelperTip = function(options) {
		...
		var getData = function(obj,e){
			if (opts.source == "ajax") {
				getPosition(e);
				$(opts.ttC).html('<div><img src="../scripts/'+opts.loadingImg+'"/> '+opts.loadingText+'</div>').show();
		...
		var getPosition = function (e){
			...
			var offset = $(opts.pC).offset();
			
			if (opts.source == "attribute"){
				$(opts.aC).css({
					top: offset.top+opts.topOff,
					left: offset.left+opts.leftOff,
