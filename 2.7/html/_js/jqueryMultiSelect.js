...
if(jQuery) (function($){
	...
	$.extend($.fn, {
		multiSelect: function(o, callback) {
			...
			if( o.oneOrMoreSelected == undefined ) o.oneOrMoreSelected = '% Users Selected';
			...
			$(this).each( function() {
				...
				if( o.selectAll ) html += '<label class="selectAll"><input type="checkbox" class="selectAll" CHECKED />' + o.selectAllText + '</label>';
		...
		multiSelectUpdateSelected: function(o) {
			...
			if( i == 0 ) {
				...
				if( o.oneOrMoreSelected == '*' ) {
					...
					//if($(this).find('INPUT:checkbox:checked').length == i) {
					//	$(this).prev('INPUT.multiSelect').val( o.oneOrMoreSelected.replace('%', 'All') );
					//} else {
